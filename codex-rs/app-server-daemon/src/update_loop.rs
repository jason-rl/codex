...
#[cfg(unix)]
const INSTALL_URL: &str = "https://github.com/jason-rl/codex/releases/latest/download/install.sh";
#[cfg(windows)]
const INSTALL_URL: &str = "https://github.com/jason-rl/codex/releases/latest/download/install.ps1";
